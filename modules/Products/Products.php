...
class Products extends CRMEntity {
	...
	var $list_fields = Array(
		...
		'Item Code'=>Array('products'=>'productcode'),
		'Product No'=>Array('products'=>'product_no'),
		'Product Weight'=>Array('products'=>'prd_weight'),
		'Usage Unit'=>Array('products'=>'usageunit'),
