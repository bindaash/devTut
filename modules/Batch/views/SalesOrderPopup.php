...
class Batch_SalesOrderPopup_View extends Vtiger_Popup_View {
	...
	public function initializeListViewContents(Vtiger_Request $request, Vtiger_Viewer $viewer) {
		//src_module value is added to just to stop showing inactive SalesOrder
		...
		$viewer->assign('VIEW', 'SalesOrderPopup');
	}
