...
class BatchMovement_BatchPopup_View extends Vtiger_Popup_View {
	...
	public function initializeListViewContents(Vtiger_Request $request, Vtiger_Viewer $viewer) {
		...
		foreach ($this->listViewEntries as $key => $listViewEntry) {
			$batchId = $listViewEntry->getId();
			/* $subProducts = $listViewModel->getSubProducts($batchId);
			if($subProducts) {
	...
	function getHeaderScripts(Vtiger_Request $request) {
		...
		$jsFileNames = array('modules.BatchMovement.resources.Popup');
