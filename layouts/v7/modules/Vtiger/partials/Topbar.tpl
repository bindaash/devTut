...
{strip}
	...
	<nav class="navbar navbar-default navbar-fixed-top app-fixed-navbar">
		<!--Added by Biraj Sharma on date 02052019 for Custom Reports generations-->
		<!--Start-->
		<div id="report_new_popup" title="Report" style="display:none;">
			<table class="table table-bordered" width="100%" border="0" class="small" cellspacing="1" cellpadding="3">
				<tr>
					<th class="dvtCellLabel" colspan="4"><strong>SELECT REPORT</strong></th>
				</tr>
				<tr>
					<td class="dvtCellLabel"><strong>Report Title</strong></td>
					<td class="dvtCellLabel" colspan="2"><strong>Condition</strong></td>
					<td class="dvtCellLabel"><strong>PDF</strong></td>
				</tr>

				<tr>
					<td class="dvtCellInfo">Summary reports for Warehouse</td>
					<td class="dvtCellLabel" colspan="2">
						<input type="text" id="war_dat" name="war_dat" class="dateField form-control" placeholder="Select Date">
					</td>
					
					<td class="dvtCellLabel">
						<input class="crmbutton small edit show_rep" type="button" id="batch_reports_ware" value="Show Report"/>
					</td>
				</tr>
				
				<tr>
					<td class="dvtCellInfo">Summary reports for Core</td>
					<td class="dvtCellLabel">
						<input type="text" id="from_dat" name="from_dat" class="dateField form-control" placeholder="From Date">
					</td>
					<td class="dvtCellLabel">
						<input type="text" id="to_dat" name="to_dat" class="dateField form-control" placeholder="To Date">
					</td>
					<td class="dvtCellLabel">
						<input class="crmbutton small edit show_rep" type="button" id="batch_reports_core" value="Show Report"/>
					</td>
					<!--<td class="dvtCellLabel">
						<a href="javascript:void(0);" class="crmbutton small edit"  onclick="summary_of_batch_rep_xls()"></a>
					</td>-->
				</tr>
				
				<tr>
					<td class="dvtCellInfo">Summary reports for Batch</td>
					<td class="dvtCellLabel">
						<select id="select_type" class="select_rep_bat small">
							  <option value="default">Condition</option>
							  <option value="salesOrder_id">By Sales Order No.</option>
							  <option value="product_id">By Product Name</option>
						</select>
					</td>
					<td class="dvtCellLabel">
						<select id="item_id" name="item_id" class="select_rep_bat small">
							<option value="default">Select one</option>
						</select>
					</td>
					<td class="dvtCellLabel">
						<input class="crmbutton small edit show_rep" type="button" id="batch_reports" value="Show Report" />
					</td>
				</tr>
			</table>
			<br><br>
		...
		<!--div id="report_popup" title="Report" style="display:none;">
			<table class="table table-bordered" width="100%" border="0" class="small" cellspacing="1" cellpadding="3">
				<tr>
					<th class="dvtCellLabel" colspan="4"><strong>SELECT REPORT</strong></th>
				</tr>
				<tr>
					<td class="dvtCellLabel"><strong>Report Title</strong></td>
					<td class="dvtCellLabel"><strong>Condition</strong></td>
					<td class="dvtCellLabel"><strong>Select one</strong></td>
				...
				<tr>
					...
					<td class="dvtCellLabel">
						...
						<select id="item_id" name="item_id" class="select_rep_bat small" /></select>
					</td>
					<td class="dvtCellLabel">
						<input class="crmbutton small edit show_rep" type="button" id="batch_reports" value="Show Report" />
					</td>
		...
		<div id="report_result" title="Report Result" style="display:none;"></div> 
		<!--End-->
		<div class="container-fluid global-nav">
			<div class="row">
				...
				<!--Added by Biraj Sharma on date 02/05/2019-->
				{*if $MODULE eq 'Reports'*}
				<div class="col-lg-3">
					<div class="crmbutton small edit" style="text-align: right;">
						<input id="openReportList" type="button" placeholder="{vtranslate('LBL_CUSTOM_REPORT')}" value="Custom Report" style="background:green; color:#fff; font-size:13px; padding:8px 15px;">
					</div>
				</div>
				{*/if*}
