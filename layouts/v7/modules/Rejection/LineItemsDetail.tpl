{* modules/Rejection/views/Detail.php *}
{assign var=LINE_ITEM_BLOCK_LABEL value="LBL_ITEM_REJECTION_DETAILS"}
        ...
        <table class="table table-bordered lineItemsTable" style = "margin-top:15px">
            ...
            <tbody>
				<tr>
					...
					<td class="lineItemFieldName">
					<strong>{vtranslate('LBL_REASON',$MODULE)}</strong>
					</td>
					<td class="lineItemFieldName">
				...
				<tr>
					...
					<td>
					{$LINE_ITEM_DETAIL["rej_reason$INDEX"]}
					</td>
					<td>
