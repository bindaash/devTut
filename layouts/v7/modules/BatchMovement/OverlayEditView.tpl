...
<script type="text/javascript" src="{vresource_url('layouts/v7/modules/BatchMovement/resources/Edit.js')}"></script>
...
<div class='fc-overlay-modal overlayEdit'>
    <div class = "modal-content">
        <div class="overlayHeader">
            {assign var=TITLE value="{vtranslate('LBL_EDITING', $MODULE)} 
        ...
        <form class="form-horizontal recordEditView" id="EditView" name="edit" method="post" action="index.php" enctype="multipart/form-data">
            <div class = "modal-body editViewBody">
                <div class="editViewContents">
                    ...
                    {/if}
                    {*include file="partials/EditViewContents.tpl"|@vtemplate_path:'BatchInventory'*}
                    {include file="partials/LineItemsEdit.tpl"|@vtemplate_path:'BatchMovement'}
                </div>
            </div>
