...
<script type="text/javascript" src="{vresource_url('layouts/v7/modules/Dispatch/resources/Edit.js')}"></script>
        ...
        <form class="form-horizontal recordEditView" id="EditView" name="edit" method="post" action="index.php" enctype="multipart/form-data">
            <div class = "modal-body editViewBody">
                <div class="editViewContents">
                    ...
                    {/if}
                    {*include file="partials/EditViewContents.tpl"|@vtemplate_path:'DispatchInventory'*}
                    {include file="partials/LineItemsEdit.tpl"|@vtemplate_path:'DispatchInventory'}
                </div>
            </div>
